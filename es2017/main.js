...
import { model as Max, LoadAssets } from "./utils/loaders.js";
console.log(Max);
var res = await LoadAssets();
var listener = new THREE.AudioListener();
var audio = new THREE.PositionalAudio(listener);
var debugActive = window.location.hash === "#debug";
...
var start = function () { return __awaiter(void 0, void 0, void 0, function () {
    var mindarThree, renderer, scene, camera, sound, audioLoader, ambienLight, directionalLight, anchor;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                ambienLight = new THREE.AmbientLight("#2630ba", 1.02);
                directionalLight = new THREE.DirectionalLight("#fffcf0", 4.223);
